%% MIE377 (Winter 2023) - Laboratory 3
...
% Load the sample historical data (same data as Lab 2)
load('lab2data.mat')
...
for i = 1 : n
    sigma_im = cov(exRets(:,i), exFacRets);
    betaCAPM(i) = sigma_im(2,1)/sigmaF;
end
