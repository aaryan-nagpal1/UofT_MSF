...
% The purpose of this laboratory is to solve a mixed-integer quadratic 
% program (MIQP) that finds an optimal portfolio with a cardinality 
% constraint and a buy-in threshold. We will use the optimizer Gurobi to 
% solve this MIQP. Gurobi is an optimization software that we can call from 
% within Matlab.
%
% TA: David Islip
